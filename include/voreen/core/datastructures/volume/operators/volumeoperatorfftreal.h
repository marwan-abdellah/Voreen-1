...
#ifndef VRN_VOLUMEOPERATORFFTREAL_H
#define VRN_VOLUMEOPERATORFFTREAL_H
...
class VRN_CORE_API VolumeOperatorFFTRealBase : public UnaryVolumeOperatorBase {
public:
...
template<typename T>
class VolumeOperatorFFTRealGeneric : public VolumeOperatorFFTRealBase {
public:
...
template<typename T>
Volume* VolumeOperatorFFTRealGeneric<T>::apply(const VolumeBase* vh) const {
...
typedef UniversalUnaryVolumeOperatorGeneric<VolumeOperatorFFTRealBase> VolumeOperatorFFTReal;

} // namespace

#endif // VRN_VOLUMEOPERATORFFTREAL_H
